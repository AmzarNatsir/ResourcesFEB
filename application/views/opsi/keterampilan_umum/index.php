<div class="content-wrapper">
  <section class="content-header">
    <h1>Opsi<small>Aspek Keterampilan Umum (KU)</small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url();?>Home"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Aspek Keterampilan Umum (KU)</li>
    </ol>
  </section>
  <!-- Main content -->
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">DAFTAR KETERAMPILAN UMUM</h3>
            <div class="box-tools">
          ...
          <div class="box-body table-responsive">
            <table id="tabel_data" class="table table-bordered tabel_data table-striped">
                <thead>
                    ...
                    <th style="width: 80%">Aspek Keterampilan Umum</th>
                          ...
                          <div class="margin">
                            <div class="btn-group">
                              ...
                              <ul class="dropdown-menu" role="menu">
                                <li><a href="#" data-toggle="modal" class="tbl_edit" data-target="#modal-edit" id="<?php echo $dt['id_ku'];?>">Edit</a></li>
                                <li><a href="#" class="tbl_hapus" id="<?php echo $dt['id_ku'];?>">Hapus</a></li>
                              </ul>
                            </div>
                          </div>
                        </td>
...
<div class="modal modal-primary fade" id="modal-tambah" data-backdrop="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form role="form" method="post" action="<?php echo base_url();?>opsi/keterampilan_umum_simpan" onsubmit="return konfirm()">
      <div class="modal-body">
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" id="nm_aspek_ku" name="nm_aspek_ku" required></textarea>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  $(document).ready(function() 
  {
    ...
    {
      var id_data = this.id;
      $("#frm_modal").load("<?php echo base_url();?>opsi/keterampilan_umum_edit/"+id_data);
    });
    $(".tbl_hapus").on("click", function()
    {
      ...
      if(psn==true)
      {
        $.ajax (
        {
            url : "<?php echo site_url();?>opsi/keterampilan_umum_hapus",
            type : "post",
            data : {id_data:id_data},
            success : function(d)
            {
                alert(d)
                window.location.assign("<?php echo base_url();?>opsi/keterampilan_umum");
            }
         });
      }
    });
