<div class="content-wrapper">
  <section class="content-header">
    <h1>Opsi | Career Center | <small>Kecamatan</small></h1>
    <ol class="breadcrumb">
              ...
              <table id="tabel_data" class="table table-bordered tabel_data table-striped">
                  ...
                  <tbody>
                        ...
                        foreach ($list_provinsi as $dt) {
                            ...
                            <tr>
                                <td><?php echo $nom;?></td>
                                <td colspan="4"><?php echo $dt['nama_provinsi'];?></td>
                            </tr>
                            <?php
                            if(!empty($all_kab))
                            { 
                                ...
                                { 
                                    ...
                                    <tr>
                                        <td></td>
                                        <td></td>
                                        <td colspan="2"><?php echo $kab['nama_kabupaten'];?></td>
                                        <td>
                                            <button type="button" class="btn btn-primary tbl_add" data-toggle="modal" data-target="#modal-tambah" id="<?php echo $kab['id'];?>"><i class="fa fa-plus"></i> Tambah Kecamatan</button>
                                        </td>
                                    </tr>
                                    <?php
                                    if(!empty($all_kec))
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <li><a href="#" data-toggle="modal" class="tbl_edit" data-target="#modal-edit" id="<?php echo $kec['id'];?>">Edit</a></li>
                                                    <li><a href="#" class="tbl_hapus" id="<?php echo $kec['id'];?>">Hapus</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
...
<script type="text/javascript">
  $(document).ready(function() 
  {
    ...
    {
      var id_data = this.id;
      $("#frm_modal_add").load("<?php echo base_url();?>opsi/kecamatan_add/"+id_data);
    });
    $(".tabel_data").on("click", ".tbl_edit", function()
    {
      var id_data = this.id;
      $('.select2').select2();
      $("#frm_modal").load("<?php echo base_url();?>opsi/kecamatan_edit/"+id_data);
    });
    $(".tabel_data").on("click", ".tbl_hapus", function()
    {
      ...
      if(psn==true)
      {
        $.ajax (
        {
            url : "<?php echo site_url();?>opsi/kecamatan_hapus",
            type : "post",
            data : {id_data:id_data},
            success : function(d)
            {
                alert(d)
                window.location.assign("<?php echo base_url();?>opsi/kecamatan");
            }
         });
      }
    });
