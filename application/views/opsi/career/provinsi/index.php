<div class="content-wrapper">
  <section class="content-header">
    <h1>Opsi | Career Center | <small>Provinsi</small></h1>
    <ol class="breadcrumb">
...
<div class="modal modal-primary fade" id="modal-tambah" data-backdrop="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form role="form" method="post" action="<?php echo base_url();?>opsi/provinsi_simpan" onsubmit="return konfirm()">
      <div class="modal-body">
        <div class="box-body">
          <div class="form-group">
            <label for="nm_provinsi">Nama Provinsi</label>
            <input type="text" name="nm_provinsi" id="nm_provinsi" class="form-control" maxlength="100" required>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
  $(document).ready(function() 
  {
    ...
    {
      var id_data = this.id;
      $("#frm_modal").load("<?php echo base_url();?>opsi/provinsi_edit/"+id_data);
    });
    $(".tbl_hapus").on("click", function()
    {
      ...
      if(psn==true)
      {
        $.ajax (
        {
            url : "<?php echo site_url();?>opsi/provinsi_hapus",
            type : "post",
            data : {id_data:id_data},
            success : function(d)
            {
                alert(d)
                window.location.assign("<?php echo base_url();?>opsi/provinsi");
            }
         });
      }
    });
