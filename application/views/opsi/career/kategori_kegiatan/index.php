<div class="content-wrapper">
  <section class="content-header">
    <h1>Opsi | Career Center | <small>Kategori Kegiatan</small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url();?>home"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Kategori Kegiatan</li>
    </ol>
  </section>
  <!-- Main content -->
...
<div class="modal modal-primary fade" id="modal-tambah" data-backdrop="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form role="form" method="post" action="<?php echo base_url();?>opsi/kategori_kegiatan_simpan" onsubmit="return konfirm()">
      <div class="modal-body">
        <div class="box-body">
          <div class="form-group">
            <label for="nm_kategori">Nama Kategori Kegiatan</label>
...
<script type="text/javascript">
  $(document).ready(function() 
  {
    ...
    {
      var id_data = this.id;
      $("#frm_modal").load("<?php echo base_url();?>opsi/kategori_kegiatan_edit/"+id_data);
    });
    $(".tbl_hapus").on("click", function()
    {
      ...
      if(psn==true)
      {
        $.ajax (
        {
            url : "<?php echo site_url();?>opsi/kategori_kegiatan_hapus",
            type : "post",
            data : {id_data:id_data},
            success : function(d)
            {
                alert(d)
                window.location.assign("<?php echo base_url();?>opsi/kategori_kegiatan");
            }
         });
      }
    });
