<div class="content-wrapper">
  <section class="content-header">
    <h1>Opsi<small>Kategori Berita</small></h1>
    <ol class="breadcrumb">
          ...
          <div class="box-body">
              ...
              <table id="tabel_data" class="table table-bordered tabel_data table-striped">
                  <thead>
                      ...
                      <th style="width: 80%">Kategori Berita</th>
...
<div class="modal modal-primary fade" id="modal-tambah" data-backdrop="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form role="form" method="post" action="<?php echo base_url();?>opsi/kategori_berita_simpan" onsubmit="return konfirm()">
...
<script type="text/javascript">
  $(document).ready(function() 
  {
    ...
    {
      var id_data = this.id;
      $("#frm_modal").load("<?php echo base_url();?>opsi/kategori_berita_edit/"+id_data);
    });
    $(".tbl_hapus").on("click", function()
    {
      ...
      if(psn==true)
      {
        $.ajax (
        {
            url : "<?php echo site_url();?>opsi/kategori_berita_hapus",
            type : "post",
            data : {id_data:id_data},
            success : function(d)
            {
                alert(d)
                window.location.assign("<?php echo base_url();?>opsi/kategori_berita");
            }
         });
      }
    });
