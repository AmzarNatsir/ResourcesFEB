<div class="content-wrapper">
  <section class="content-header">
    <h1>Opsi<small>Kategori FAQ</small></h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url();?>home"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Kategori FAQ</li>
    </ol>
  </section>
  <!-- Main content -->
          ...
          <div class="box-body">
              ...
              <table id="tabel_data" class="table table-bordered tabel_data table-striped">
                  <thead>
                      ...
                      <th style="width: 80%">Kategori FAQ</th>
                          ...
                          <td>
                              <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                  <li><a href="#" data-toggle="modal" class="tbl_edit" data-target="#modal-edit" id="<?php echo $dt['id_kat_faq'];?>">Edit</a></li>
                                  <li><a href="#" class="tbl_hapus" id="<?php echo $dt['id_kat_faq'];?>">Hapus</a></li>
                                </ul>
                              </div>
                          </td>
                      </tr>
...
<div class="modal modal-primary fade" id="modal-tambah" data-backdrop="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form role="form" method="post" action="<?php echo base_url();?>opsi/kategori_faq_simpan" onsubmit="return konfirm()">
...
<script type="text/javascript">
  $(document).ready(function() 
  {
    ...
    {
      var id_data = this.id;
      $("#frm_modal").load("<?php echo base_url();?>opsi/kategori_faq_edit/"+id_data);
    });
    $(".tbl_hapus").on("click", function()
    {
      ...
      if(psn==true)
      {
        $.ajax (
        {
            url : "<?php echo site_url();?>opsi/kategori_faq_hapus",
            type : "post",
            data : {id_data:id_data},
            success : function(d)
            {
                alert(d)
                window.location.assign("<?php echo base_url();?>opsi/kategori_faq");
            }
         });
      }
    });
