<div class="content-wrapper">
  <section class="content-header">
    <h1>Home Page<small>Slide</small></h1>
    <ol class="breadcrumb">
          ...
          <div class="box-body">
            <table class="table" width="100%">
              <thead>
                ...
                <th style="width: 95%">Judul/Deskripsi</th>
              </thead>
              <tbody>
...
<div class="modal modal-primary fade" id="modal-add" data-backdrop="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url();?>slide/simpan_data" method="post" onsubmit="return konfirm()" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="form-group">
            <label for="inp_kategori">Judul Slide</label>
            <input type="text" name="inp_judul" id="inp_judul" class="form-control" maxlength="50">
          </div>
          <div class="form-group">
...
<script type="text/javascript">
  $(document).ready(function()
  {
    ...
    {
      var id_data = this.id;
      $("#frm_modal").load("<?php echo base_url();?>slide/edit_data/"+id_data);
    });
    $(".tbl_hapus").on("click", function()
    {
      ...
      if(psn==true)
      {
        $.ajax (
        {
            url : "<?php echo site_url();?>slide/hapus_data",
            type : "post",
            data : {id_data:id_data},
            success : function(d)
            {
                alert(d)
                window.location.assign("<?php echo base_url();?>slide");
            }
         });
      }
    });
