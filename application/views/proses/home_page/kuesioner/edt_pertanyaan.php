        ...
        <div class="card">
            <div class="card-body">
              <div class="form-group">
                ...
                <label class="col-sm-9 col-form-label">: <?php echo $dt_dk->tema_kue;?></label>
              </div>
              <div class="form-group">
                ...
                foreach ($arr_jenis as $key => $value) {
                  if($key==$dt_dk->jenis_kuesioner)
                  {
                    echo $value;
                  }
                }?></label>
                <label class="col-sm-3 col-form-label">Status</label>
                <label class="col-sm-3 col-form-label">: <?php if($dt_dk->status==1) { echo "Aktif"; } else { echo "Tidak Aktif"; } ?></label>
              </div>
            </div>
        </div>
    </div>
