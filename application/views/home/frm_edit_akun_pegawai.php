<form role="form" method="post" action="<?php echo base_url();?>home/rubah_akun_pegawai" onsubmit="return konfirm()">
  <div class="modal-body">
    ...
    <div class="box-body">
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" name="inp_nomor_induk" id="inp_nomor_induk" class="form-control" value="<?php echo $profil_akun->no_induk;?>" readonly>
        </div>
      </div>
      <div class="form-group row">
        <label for="inp_nama" class="col-sm-2 col-form-label">Nama Pegawai</label>
        <div class="col-sm-10">
          <input type="text" name="inp_nama" id="inp_nama" class="form-control" value="<?php echo $profil_akun->nama_pegawai;?>" readonly>
        </div>
      </div>
      <div class="form-group row">
